...
export const Header: React.FC<HeaderProps> = ({ onOpenCopilot, onToggleMobileSidebar }) => {
  ...
  return (
    <header className="bg-white px-4 sm:px-6 py-3 flex items-center justify-between border-b border-slate-200 text-slate-900 relative z-30 shadow-xs">
      <div className="flex items-center space-x-3">
        ...
        <div className="w-9 h-9 rounded-xl bg-[#66A3BF] flex items-center justify-center text-white shadow-sm shrink-0">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3 text-xs">
          ...
          {onOpenCopilot && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 rounded-xl bg-slate-100 text-[#4874A0] border border-slate-200 hover:bg-slate-200 transition-all font-semibold"
            >
