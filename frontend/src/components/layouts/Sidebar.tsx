...
export const Sidebar: React.FC<SidebarProps> = ({ role, activeItem, onSelect, isOpenMobile }) => {
  ...
  return (
    <aside className={`w-64 bg-slate-900/90 backdrop-blur-xl border-r border-slate-800 flex flex-col justify-between py-6 px-4 shrink-0 ${
      ...
      <div className="px-3 pt-4 border-t border-slate-800 text-[11px] text-slate-500">
        Placement & Governance System v1.0
      </div>
    </aside>
  );
};
